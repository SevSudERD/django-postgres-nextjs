...
export function AuthProvider({children}) {
  ...
  return <AuthContext.Provider value={{isAuthenticated, login, logout, loginRequiredRedicrect, username}}>{children}</AuthContext.Provider>
}
